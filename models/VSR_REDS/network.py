...
# /home/user/zk/data1/zk/vsr/rethinking_vsr/libs/speConv/modules/speConv.py
# from libs.speConv.modules.speConv import sepConv
sys.path.append('/home/hailangwu/zk/package/')
...
class RTA_VSR(nn.Module):
    def __init__(self, cfg=None):
        ...
        self.nframes = cfg.DATASET.NFRAME
        ...
        # self._smoothing = GaussianSmoothing(3,7,2)
        self._init_var()
    ...
    def forward(self, x,gt = None):
        ...
        f_10_a,offset_10_a = self.hr_align_l(nbr_l[self.nbr-2],\
                        nbr_l[self.nbr-1],offset_2_a)
        f_11_a,offset_11_a = self.hr_align_l(f_10_a,ref_fea,self.motion_fusion(offset_10_a,offset_2_a))

        f_40_a,offset_40_a = self.hr_align_l(nbr_l[self.nbr+1],\
                        nbr_l[self.nbr],offset_3_a)
        f_41_a,offset_41_a = self.hr_align_l(f_40_a,\
                        ref_fea,self.motion_fusion(offset_40_a,offset_3_a))
...
if __name__ == '__main__':
    ...
    net.eval()
    net.to(device)
    print("RTA_VSR(REDS) have {:.3f}M paramerters in total".format(sum(x.numel() for x in net.parameters())/1000000.0))
